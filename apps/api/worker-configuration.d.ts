/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.typegen --strict-vars=false` (hash: 25917b89268a3f524c6ecd6a1cff2655)
// Runtime types generated with workerd@1.20260801.1 2026-05-21 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	...
	ACTIVITY_HISTORY_QUEUE: Queue;
	NOTIFICATION_EVENTS_QUEUE: Queue;
	REMINDER_EMAIL_QUEUE: Queue;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "MCP_WRITES_ENABLED" | "EMAIL_FROM_ADDRESS" | "EMAIL_FROM_NAME">> {}
}
