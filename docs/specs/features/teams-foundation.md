...
| `S4`  | `sharing` descriptor on the dashboard + search read models — delivered as [dashboard.md](./dashboard.md) `S3` + [app-search.md](./app-search.md) `S3`                                                                                                                | [#74](https://github.com/snaveevans/pineapple/issues/74) | `S2`       |
| `S5`  | Web sharing badges — library / dashboard / search. No tagged criteria here; they are [asset-library.md](./asset-library.md) `S3`, [dashboard.md](./dashboard.md) `S4`, and [app-search.md](./app-search.md) `S4`, plus [docs/web/FEATURES.md](../../web/FEATURES.md) | [#59](https://github.com/snaveevans/pineapple/issues/59) | `S4`       |
